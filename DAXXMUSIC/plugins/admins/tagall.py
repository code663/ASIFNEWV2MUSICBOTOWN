...
TAGMES = [ " **𝐇𝐞𝐲 𝐁𝐚𝐛𝐲 𝐊𝐚𝐡𝐚 𝐇𝐨🥱** ",
           ...
           " ** [ @ANGEL_K_WORLD ]𝐘𝐞𝐬𝐚𝐛𝐤𝐢 𝐊𝐢 𝐁𝐞𝐡𝐞𝐧 𝐇𝐚𝐢😁** ",
           ...
           " **𝐌𝐞𝐫𝐞 𝐒𝐞 𝐃𝐨𝐬𝐭𝐢 𝐊𝐫𝐨𝐠𝐞..??🤔** ",
           " ** [ @smart_hu ]𝐘𝐞 𝐉𝐚𝐧𝐧 𝐇𝐚𝐢 𝐓𝐮𝐦𝐡𝐚𝐫𝐚🙈** ",
           " **𝐄𝐤 𝐒𝐨𝐧𝐠 𝐏𝐥𝐚𝐲 𝐊𝐫𝐨 𝐍𝐚 𝐏𝐥𝐬𝐬😕** ",
           " ** [ @ANGEL_K_WORLD ]𝐘𝐞 𝐒𝐚𝐛𝐤𝐚 𝐁𝐚𝐛𝐮 𝐇𝐚𝐢🙃** ",
           " **𝐇𝐞𝐥𝐥𝐨 𝐉𝐢 𝐍𝐚𝐦𝐚𝐬𝐭𝐞😛** ",
           " **𝐇𝐞𝐥𝐥𝐨 𝐁𝐚𝐛𝐲 𝐊𝐤𝐫𝐡..?🤔** ",
           ...
           " **𝐍𝐢𝐜𝐞 𝐓𝐨 𝐌𝐞𝐞𝐭 𝐔𝐡☺** ",
           " ** [ @smart_hu ]𝐍𝐚𝐦 𝐓𝐨 𝐒𝐮𝐧𝐚𝐢 𝐇𝐨𝐠𝐚😌** ",
           " ** [ @IND_PAWAN ]𝐘𝐞 𝐀𝐰𝐚𝐣𝐞 𝐍𝐢𝐤𝐚𝐥𝐭𝐚 𝐇𝐚𝐢 𝐌𝐞𝐫𝐢 𝐉𝐚𝐧𝐚 😺** ",
           " **𝐁𝐨𝐥𝐨 𝐍𝐚 𝐊𝐮𝐜𝐡 𝐘𝐫𝐫🥲** ",
           " **𝐌𝐢𝐬𝐬𝐪𝐮𝐞𝐞𝐧 𝐊𝐨𝐧 𝐇𝐚𝐢...??😅** ",
           ...
           " **𝐉𝐚𝐛 𝐋𝐚𝐝𝐤𝐢 𝐇𝐨 𝐈𝐬𝐬 𝐒𝐞 𝐃𝐨𝐬𝐭𝐢 𝐊𝐚𝐫𝐨[ @smart_hu ]😁** ",
           " **𝐘𝐚𝐡𝐚 𝐀𝐚 𝐉𝐚𝐨:- [ @IND_PAWAM ] 𝐌𝐚𝐬𝐭𝐢 𝐊𝐚𝐫𝐞𝐧𝐠𝐞 🤭🤭** ",
           " **𝐓𝐫𝐮𝐭𝐡 𝐀𝐧𝐝 𝐃𝐚𝐫𝐞 𝐊𝐡𝐞𝐥𝐨𝐠𝐞..? 😊** ",
           " **𝐀𝐚𝐣 𝐌𝐮𝐦𝐦𝐲 𝐍𝐞 𝐃𝐚𝐭𝐚 𝐘𝐫🥺🥺** ",
           " **𝐉𝐨𝐢𝐧 𝐊𝐚𝐫 𝐋𝐨:- [ @IND_PAWAM ]🤗** ",
           " **𝐌𝐚𝐢 𝐡𝐮𝐧 𝐤𝐨𝐧:- [ @smart_hu ]🤗** ",
           " **𝐄𝐤 𝐃𝐢𝐥 𝐇𝐚𝐢 𝐄𝐤 𝐃𝐢𝐥 𝐇𝐢 𝐓𝐨 𝐇𝐚𝐢😗😗** ",
           " **𝐓𝐮𝐦𝐡𝐚𝐫𝐞 𝐃𝐨𝐬𝐭 𝐊𝐚𝐡𝐚 𝐆𝐲𝐞🥺** ",
           " **𝐌𝐲 𝐔𝐧𝐜𝐮𝐭𝐞 𝐎𝐰𝐧𝐞𝐫 [ @smart_hu ]🥰** ",
           " **𝐊𝐮𝐩𝐚𝐝𝐞 𝐏𝐚𝐥𝐚𝐮𝐜𝐡𝐚 𝐉😜** ",
           " **𝐆𝐨𝐨𝐝 𝐍8 𝐉𝐢 𝐁𝐡𝐮𝐭 𝐑𝐚𝐭 𝐇𝐨 𝐠𝐲𝐢🥰** ",
           " ** [ @smart_x_music_bot ] 𝐄𝐯𝐢𝐥 𝐍𝐞 𝐊𝐚𝐡𝐚 𝐊𝐢 𝐘𝐞 𝐂𝐡𝐢𝐩𝐤𝐚𝐥𝐢 𝐇𝐚𝐢😁** ",
           " **𝐊𝐧 𝐊𝐡𝐚𝐢𝐥𝐚👀** ",
           " **𝐓𝐚𝐦𝐞 𝐌𝐚𝐭𝐞 𝐒𝐚𝐛𝐮 𝐆𝐫𝐨𝐮𝐩 𝐑𝐞 𝐀𝐝𝐝 𝐊𝐚𝐫𝐚🍫** ",
           " **𝐊𝐚𝐮 𝐂𝐥𝐚𝐬𝐬 𝐑𝐞 𝐩𝐚𝐝𝐡𝐮𝐜𝐡𝐚😄** ",
           " **𝐀𝐧𝐤𝐚 𝐏𝐲𝐚𝐚𝐫𝐢 𝐊𝐮 𝐊𝐚𝐮𝐭𝐡𝐢 𝐃𝐞𝐤𝐡𝐢𝐜𝐡𝐚 𝐊𝐢[ @smart_hi ]🤭** ",
           " **𝐘𝐞 𝐀𝐦𝐚𝐫𝐚 𝐂𝐮𝐭𝐞 𝐏𝐞𝐫𝐬𝐨𝐧 [ @ANGEL_K_WORLD ] 𝐁𝐞𝐥𝐢𝐞𝐯𝐞 𝐇𝐚𝐮𝐧𝐢 𝐉𝐚𝐝𝐢 𝐃𝐦 𝐊𝐚𝐫𝐢𝐤𝐢 𝐏𝐚𝐜𝐡𝐚𝐫𝐚☺️** ",
           " **𝐘𝐞 𝐇𝐞𝐥𝐞 𝐀𝐦𝐚𝐫𝐚 𝐁𝐚𝐝𝐚 𝐁𝐇𝐚𝐢[ @ANGEL_K_WORLD ]😄** ",
           " **𝐘𝐞 𝐏𝐚𝐫𝐚 𝐀𝐦𝐚𝐫𝐚 𝐆𝐢𝐫𝐥 𝐎𝐰𝐧𝐞𝐫[ @IND_PAWAN ]😌** ",
           " ** [ @smart_hu ]𝐈𝐬𝐬𝐤𝐨 𝐄𝐤 𝐁𝐢𝐦𝐚𝐫𝐢 𝐇𝐚𝐢 𝐈𝐬𝐤𝐨 𝐡𝐚𝐫𝐰𝐚𝐤𝐭 𝐊𝐲𝐚 𝐇𝐨 𝐭𝐚 𝐇𝐚𝐢 𝐉𝐚𝐧 𝐓𝐞 𝐇𝐨 𝐤𝐲𝐚😁** ",
           " **𝐓𝐚𝐦𝐚 𝐆𝐟 𝐍𝐮𝐦𝐛𝐞𝐫 𝐃𝐢𝐚** ",
           ]
